...
const DESIGN_ITEMS = [
  ...
  {
    category: "Prompts IA",
    key: "sofia_system_prompt",
    label: "Sistema Prompt — Sofía",
    description: "Instrucciones base de personalidad, reglas y conocimiento del ecosistema FIA para todas las conversaciones de Sofía.",
    charLimit: 15000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.reactivacion_inactividad",
    label: "Journey: Reactivación",
    description: "Instrucción al modelo para mensajes de reactivación (niveles 1, 2, 3 según días de inactividad).",
    charLimit: 2000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.celebracion_capsula",
    label: "Journey: Celebración Cápsula",
    description: "Instrucción para celebrar cápsulas completadas e impulsar la siguiente.",
    charLimit: 2000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.bienvenida_diagnostico",
    label: "Journey: Bienvenida Diagnóstico",
    description: "Primer contacto con usuario que completó el diagnóstico FIA.",
    charLimit: 2000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.recuperacion_lead_frio",
    label: "Journey: Lead Frío",
    description: "Único intento de reactivar un lead que hizo el diagnóstico pero nunca comenzó.",
    charLimit: 2000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.resumen_semanal_sponsor",
    label: "Journey: Reporte Sponsor",
    description: "Reporte semanal para el sponsor (dueño de empresa) sobre el progreso del equipo.",
    charLimit: 2000,
    type: "prompt" as const,
  },
  {
    category: "Prompts IA",
    key: "journey_prompt.campana_activa",
    label: "Journey: Campaña Activa",
    description: "Mensaje para usuarios con acceso especial desbloqueado que no han ingresado.",
    charLimit: 2000,
    type: "prompt" as const,
  },
